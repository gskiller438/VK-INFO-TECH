 ...
 * 
 * Read-only invoice display component for viewing historical bills.
 * Used exclusively in the Customers page for bill history viewing.
 * 
 * Key Differences from InvoiceTemplate:
 * - Optimized for screen viewing (not printing)
 * - No edit capabilities
 * - Used for display only, not PDF generation
 */
export default function InvoicePreview({ company, data }: InvoicePreviewProps) {
    ...
    return (
        <div className="flex flex-col bg-gray-100 text-black gap-8 pb-10">
                                    ...
                                    <table className="w-full text-[11px] font-bold">
                                        <tbody>
                                            <tr className="h-6 border-b border-gray-100">
                                                ...
                                                <td className="px-2 text-right">₹{data.subTotal.toFixed(2)}</td>
                                            </tr>
                                            {isLastPage && (
                                                <>
                                                    {data.totalGst > 0 && (
